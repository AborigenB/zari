            ...
            <div class="absolute bottom-4 right-4 flex gap-2">
                <a href="{{route('art.favorite', $art->id)}}" class="rounded-full p-2 bg-white flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="25" viewBox="0 0 31 29" fill="none">
                        <path d="M22.5 0C18.5 0 15.5 3.5 15.5 3.5C15.5 3.5 12 0 8.5 0C5 0 0 1.5 0 8.5C0 15.5 12.5 28.5 15.5 28.5C18.5 28.5 31 15 31 8.5C31 2 26.5 0 22.5 0Z" fill="{{$art->isFavorite() ? '#B02F00' : 'black'}}" class="hover:fill-[red] duration-500"/>
                    </svg>
                </a>
                <button onclick="navigator.clipboard.writeText('{{route('art.show', $art->id)}}'); itCopied(event)" class="rounded-full p-2 bg-white flex cursor-pointer">
